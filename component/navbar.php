                        ...
                        <ul>
                            ...
                            <li class="<?= ($current_page == 'genre.php') ? 'active' : ''; ?>">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="genre.php?genre=Martial%20Arts">Martial Arts</a>
                                    </li>
                                    ...
                                    <li><a class="dropdown-item" href="genre.php?genre=Psychological">Psychological</a>
                                    </li>
                ...
                <div class="header__right">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if (isset($_SESSION['name'])): ?>
                            <div class="dropdown">
                                <a class="btn btn-secondary dropdown-toggle user-dropdown" href="#" role="button"
                                ...
                                <ul class="dropdown-menu custom-dropdown" aria-labelledby="dropdownMenuLink">
                                    <li><a style="color:black;" class="dropdown-item"
                                            href="riwayat.php?username=<?php echo urlencode($_SESSION['email']); ?>">Riwayat
                                            Transaksi</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li>
                                        <a style="color:black;" class="dropdown-item" href="logout.php"
